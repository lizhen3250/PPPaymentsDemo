    ...
    option.addEventListener('click', function () {
        ...
        setTimeout(() => {
            ...
            if (config.fundingSource == 'paylater') {
                ...
                document.getElementById('paypal-bcdc-button-container').style.display = 'none';
            }
            ...
            if (config.fundingSource == 'credit') {
                ...
                document.getElementById('paypal-button-container').style.display = 'none';
                document.getElementById('paypal-paylater-button-container').style.display = 'none';
                document.getElementById('paypal-bcdc-button-container').style.display = '';
            }
...
actionButton.addEventListener('click', function () {
    const selectedPayment = document.querySelector('.payment-option.selected').getAttribute('data-payment');
    let message = '';

    switch (selectedPayment) {
        case 'credit-card':
            message = '正在跳转到信用卡支付页面...';
            break;
        case 'alipay':
            message = '正在跳转到支付宝...';
            break;
