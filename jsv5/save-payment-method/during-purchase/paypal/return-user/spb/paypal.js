...
async function loadScript() {
    var btnScript = document.createElement("script");
            ...
            btnScript.src =
                ...
                clientId +
                "&currency=USD&buyer-country=US&components=buttons,messages&disable-funding=card&commit=true&locale=en_US";
    ...
    urlencoded.append("target_customer_id", "XqiBaHSjwx");
