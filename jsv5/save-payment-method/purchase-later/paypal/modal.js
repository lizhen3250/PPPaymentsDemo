...
selectElement.addEventListener('change', function () {
    ...
    if(selectElement.value == 'PASSWORD_FREE') {
        delete physicalGoodsTemplates[0].payment_source.paypal.billing_plan;
        delete virtualGoodsTemplates[0].payment_source.paypal.billing_plan;
        delete physicalGoodsTemplates[0].payment_source.paypal.usage_pattern;
        delete virtualGoodsTemplates[0].payment_source.paypal.usage_pattern;
        
    } else if(selectElement.value == "RECURRING") {
        physicalGoodsTemplates[0].payment_source.paypal.billing_plan = blling_plan;
        physicalGoodsTemplates[0].payment_source.paypal.usage_pattern = "SUBSCRIPTION_PREPAID";
        virtualGoodsTemplates[0].payment_source.paypal.billing_plan = blling_plan;
        virtualGoodsTemplates[0].payment_source.paypal.usage_pattern = "SUBSCRIPTION_PREPAID";
    }
